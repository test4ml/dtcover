...
class ResultItem(object):
    def __init__(self, id: int, ori: Optional[str]=None, target: Optional[str]=None, inputs: Optional[str]=None, mutation: Optional[str]=None) -> None:
        self.id = id
        self.ori = ori
        self.target = target
        self.inputs = inputs
...
class LogItem(object):
    def __init__(self, kind: str, sum_type: str, cover_type: str, data_idx: int, value: float) -> None:
        self.kind = kind
