...
import string
import torch
from dtcover.goal_function_results.mcq_goal_function_result import MutipleChoiceQuestionGoalFunctionResult
from dtcover.goal_functions.classification.next_token import NextTokenGoalFunction
