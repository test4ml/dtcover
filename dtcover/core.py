...
from dtcover.hooks import DTCovProberHook
from dtcover.injection import InjectionConfig
from dtcover.metrics import NeuralMetric

from dtcover.helper import recursive_getattr, recursive_setattr
from dtcover.monitors.base_monitor import NeuralMonitor

META_PROPERTY_NAME = "_dtcov_meta"
...
class ProberMeta(object):
    def __init__(self, module_name: List[str], use_re: bool=False) -> None:
        ...
        self.hooks: Dict[str, Tuple[DTCovProberHook, Any]] = {}

    def add_hook(self, name: str, hook: DTCovProberHook, handle):
...
def add_prober(self):
    ...
    for name in replace_name:
        ...
        hook = DTCovProberHook(name, meta.metrics, meta.monitors)
