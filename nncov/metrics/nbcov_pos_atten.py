...
class NBCovPosAtten(NeuralMetric):
    ...
    def update(self, layer_name: str, layer: Union[torch.Tensor, Tuple[torch.Tensor]]):
        ...
        # activation_tensor: [batch, num_head, seq, seq]
        activation_tensor = (attn_weights > min_tensor_padded) & (attn_weights < max_tensor_padded)
