...
class MutipleChoiceQuestionGoalFunctionResult(GoalFunctionResult):
    """Represents the result of a Mutiple Choice Question goal function."""
    ...
    def __init__(
        ...
        super().__init__(
            ...
            num_queries,
            ground_truth_output,
            goal_function_result_type="MutipleChoiceQuestion",
        )
        self.output_label = output[1]
        self.output_label_id = output[0]
    ...
    def _processed_output(self):
        ...
        if self.attacked_text.attack_attrs.get("label_names") is not None:
            output = self.attacked_text.attack_attrs["label_names"][self.output_label_id]
            ...
            return self.output_label, color
